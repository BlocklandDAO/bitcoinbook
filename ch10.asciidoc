...
((("mining and consensus", "purpose of")))"Madencilik" kelimesi biraz yanıltıcıdır. Değerli metallerin çıkarılmasını çağrıştırarak, dikkatimizi her blokta oluşturulan yeni bitcoin olan madenciliğin ödülüne odaklar. Madenciliği bu ödül teşvik etse de, madenciliğin birincil amacı ödül veya yeni coinler üretmek değildir. Madenciliği yalnızca coinlerin yaratıldığı süreç olarak görüyorsanız, araçları (ödülleri) sürecin amacı olarak karıştırıyorsunuz. Madencilik, işlemlerin doğrulandığı ve temizlendiği merkeziyetsiz takas odasının temelini oluşturan mekanizmadır. Madencilik, bitcoin'i özel yapan buluş, P2P dijital paranın temeli olan merkeziyetsiz bir güvenlik mekanizmasıdır.

((("mining and consensus", "decentralized consensus")))((("central trusted authority")))Madencilik, Bitcoin sistemini güvence altına alır ve merkezi bir otorite olmadan ağ çapında fikir birliğinin (konsensüs) ortaya çıkmasını sağlar. Yeni basılan coinler ve işlem ücretlerinin ödülü, madencilerin eylemlerini ağın güvenliğiyle uyumlu hale getirirken aynı zamanda para arzını da uygulayan bir teşvik planıdır.

[İpucu]
====
((("decentralized systems", "bitcoin mining and")))Madenciliğin amacı yeni bitcoin yaratmak değildir. Teşvik sistemi budur. Madencilik, bitcoin güvenliğinin merkeziyetsizleştirildiği mekanizmadır.
====

Madenciler yeni işlemleri doğrular ve  bunları küresel deftere kaydeder. Son bloktan bu yana gerçekleşen işlemleri içeren yeni bir blok, ortalama olarak her 10 dakikada bir "mine" edilir  (çıkarılır) ve bu işlemler blok zincirine eklenir. Bir bloğun parçası haline gelen ve blok zincirine eklenen işlemler "onaylanmış" olarak kabul edilir, bu da yeni bitcoin sahiplerinin aldıkları bitcoin'i bu işlemlerde harcamasına olanak tanır.

((("fees", "mining rewards")))((("mining and consensus", "mining rewards and fees")))((("Proof-of-Work algorithm")))((("mining and consensus", "Proof-of-Work algorithm")))Madenciler, madenciliğin sağladığı güvenlik karşılığında iki tür ödül alırlar: blok ödülü veya coin ödülü olarak da bilinen her yeni blokla oluşturulan yeni coinler ve bloğa dahil edilen tüm işlemlerden işlem ücretleri. Bu ödülü kazanmak için madenciler, kriptografik bir karma algoritmaya dayalı zor bir matematik problemini çözmek için yarışırlar. Proof-of-Work adı verilen sorunun çözümü, yeni bloğa dahil edilmiştir ve madencinin önemli hesaplama çabası harcadığının kanıtı olarak işlev görür. Ödül kazanmak için Proof of Work algoritmasını çözme rekabeti ve blok zincirindeki işlemleri kaydetme hakkı, bitcoin'in güvenlik modelinin temelidir.

Sürece madencilik denir çünkü ödül (yeni coin üretimi), tıpkı değerli metaller için madencilik gibi azalan getirileri simüle etmek için tasarlanmıştır. Bitcoin'in para arzı, bir merkez bankasının banknot basarak yeni para basmasına benzer şekilde madencilik yoluyla yaratılır. Bir madencinin bir bloğa ekleyebileceği maksimum yeni oluşturulan bitcoin miktarı yaklaşık her dört yılda bir (veya tam olarak her 210.000 blokta bir) azalır. Ocak 2009'da blok başına 50 bitcoin ile başladı ve Kasım 2012'de blok başına 25 bitcoin'e yarıya düştü. Temmuz 2016'da 12.5 bitcoin'e ve Mayıs 2020'de tekrar 6.25 bitcoin'e yarıya indi. Bu formüle göre, tüm bitcoinlerin (20.99999998 milyon) çıkarılacağı yaklaşık 2140 yılına kadar bitcoin madenciliği ödülleri katlanarak düşüyor 2140'tan sonra yeni bitcoin basılmayacak.

Bitcoin madencileri ayrıca işlemlerden ücret alırlar. Her işlem genellikle, işlemin girdileri ve çıktıları arasında bir bitcoin fazlası şeklinde bir işlem ücreti içerir. Bitcoin kazanan madenci, kazanan blokta yer alan işlemlerde "değişikliği korur". Bugün, ücretler bir bitcoin madencisinin gelirinin %0,5'ini veya daha azını temsil ediyor, büyük çoğunluğu yeni basılan bitcoin'den geliyor. Bununla birlikte, blok ödülü zamanla azaldıkça ve blok başına işlem sayısı arttıkça, bitcoin madenciliği kazançlarının daha büyük bir kısmı ücretlerden gelecektir. Yavaş yavaş, madencilik ödülü, madenciler için birincil teşvik oluşturacak olan işlem ücretleri tarafından domine edilecek. 2140'tan sonra, her bloktaki yeni bitcoin miktarı sıfıra düşer ve bitcoin madenciliği yalnızca işlem ücretleri ile teşvik edilir.

Bu bölümde, önce madenciliği parasal bir tedarik mekanizması olarak inceleyeceğiz ve ardından madenciliğin en önemli işlevine bakacağız: bitcoin'in güvenliğini destekleyen merkezi olmayan konsensüs mekanizması.

Madenciliği ve konsensüsü anlamak için, Alice'in işlemini Jing'in madencilik ekipmanı tarafından alındığında ve bir bloğa eklendiğinde takip edeceğiz. Ardından, bloğu çıkarıldığı, blok zincirine eklendiği ve ortaya çıkan konsensüs süreci boyunca Bitcoin ağı tarafından kabul edildiği gibi takip edeceğiz.

==== Bitcoin Ekonomisi ve Coin Oluşumu

((("mining and consensus", "bitcoin economics and currency creation")))((("currency creation")))((("money supply")))((("issuance rate")))Bitcoin, her bloğun oluşturulması sırasında sabit ve azalan bir oranda "mint edilir" (basılır). Ortalama olarak her 10 dakikada bir oluşturulan her blok, sıfırdan yaratılmış tamamen yeni bitcoin içerir. Her 210.000 blokta bir veya yaklaşık olarak her dört yılda bir,bircoin çıkarma oranı %50 oranında azaltılır. Ağın ilk dört yılı boyunca, her blok 50 yeni bitcoin içeriyordu.

Kasım 2012'de yeni Bitcoin emisyon oranı blok başına 25 bitcoin'e düşürüldü. 2016 yılının Temmuz ayında blok başına 12,5 bitcoin'e düşürüldü ve 2020 yılının Mayıs ayında tekrar blok başına 6,25 bitcoin'e düşürüldü. Yeni coinlerin oranı, minimum para birimi 1 satoshi'ye ulaştığında, 6.720.000 bloğuna (yaklaşık olarak 2137 yılında çıkarılan) kadar 32 "halving’e"(yarılanma)  kadar katlanarak azalır. Son olarak, 6.93 milyon bloktan sonra, yaklaşık 2140'ta yaklaşık 2.099.999.997.690.000 satoshi veya yaklaşık 21 milyon bitcoin basılacak. Bundan sonra, bloklar yeni bitcoin içermeyecek ve madenciler yalnızca işlem ücretleri ile ödüllendirilecektir. Geometrik olarak azalan bir emisyon oranına dayalı olarak zaman içinde bitcoin arzı, bitcoin emisyonu azaldıkça zaman içinde dolaşımdaki toplam bitcoin miktarını gösterir.

[[bitcoin_money_supply]]
.Geometrik olarak azalan bir emisyon oranına dayalı olarak zaman içinde bitcoin para birimi arzı.
image::images/mbc2_1001.png["BitcoinMoneySupply"]

[NOT]
====
Çıkarılan maksimum coin sayısı, bitcoin için olası madencilik ödüllerinin üst sınırıdır. Pratikte, bir madenci, tam ödülden daha azını alarak kasıtlı olarak bir blok madenciliği yapabilir. Bu tür bloklar zaten çıkarılmıştır ve gelecekte daha fazlası çıkarılabilir, bu da para biriminin toplam emisyonunun daha düşük olmasına neden olur.
====

Toplam Bitcoin'in ne kadar çıkarılacağını hesaplamak için A komut dosyasındaki örnek kodda, verilecek toplam bitcoin miktarını hesaplıyoruz.

[[max_money]]
.Toplam ne kadar bitcoin çıkarılacağını hesaplamak için bir komut dosyası
====
[source, python]
----
...
max_money.py scrpitini çalıştırmak. bu scripti çalıştırarak üretilen çıktıyı gösterir.

[[max_money_run]]
.max_money.py scriptini çalıştırma
====
[source,bash]
----
$ python max_money.py
...
Sınırlı ve azalan emisyon, enflasyona direnen sabit bir para arzı yaratır. Bir merkez bankası tarafından sonsuz sayıda basılabilen itibari para biriminin aksine, bitcoin asla basılarak şişirilemez.

Deflasyonist Para
****
((("deflationary money")))Sabit ve azalan para emisyonun en önemli ve tartışılan sonucu, para biriminin doğası gereği deflasyonist olma eğiliminde olmasıdır. Deflasyon, bir para biriminin değerini (ve döviz kurunu) artıran arz ve talep uyumsuzluğu nedeniyle değerin değer kazanması olgusudur. Enflasyonun tersi olan fiyat deflasyonu, paranın zaman içinde daha fazla satın alma gücüne sahip olduğu anlamına gelir.

Birçok ekonomist, deflasyonist bir ekonominin ne pahasına olursa olsun kaçınılması gereken bir felaket olduğunu savunuyor. Bunun nedeni, hızlı bir deflasyon döneminde, insanların fiyatların düşeceğini umarak harcamak yerine para biriktirme eğiliminde olmalarıdır. Böyle bir fenomen, talebin tamamen çökmesi para birimini deflasyonist bir sarmalın içine ittiğinde, Japonya'nın "Kayıp On Yılı" sırasında ortaya çıktı.

Bitcoin uzmanları, deflasyonun başlı başına kötü olmadığını savunuyor. Bunun yerine, deflasyon talepteki bir çöküşle ilişkilidir, çünkü bu, üzerinde çalışmamız gereken tek deflasyon örneğidir. Sınırsız basım imkanına sahip itibari para biriminde, talepte tam bir çöküş ve para basma isteksizliği olmadıkça deflasyonist bir sarmalın içine girmek çok zordur. Bitcoin'deki deflasyon, talepteki bir çöküşten değil, öngörülebilir şekilde kısıtlı bir arzdan kaynaklanır.

Deflasyonun olumlu yanı elbette enflasyonun tam tersi olmasıdır. Enflasyon, para biriminde yavaş ama kaçınılmaz bir değer kaybına neden olur ve borçluları (en büyük borçlular, hükümetler dahil) kurtarmak için tasarruf sahiplerini cezalandıran bir tür gizli vergilendirme ile sonuçlanır. Hükümet kontrolü altındaki para birimleri, daha sonra tasarruf sahiplerinin pahasına değer düşürme yoluyla silinebilecek olan kolay borç ihraç etmenin ahlaki tehlikesinden muzdariptir.

Para biriminin deflasyonist yönünün, hızlı ekonomik geri çekilme tarafından yönlendirilmediğinde bir sorun mu yoksa enflasyon ve değer düşüklüğüne karşı koruma ve deflasyon risklerinden çok daha ağır bastığı için bir avantaj mı olduğunu göreceğiz.
****

=== Merkeziyetsiz Konsensüs

((("mining and consensus", "decentralized consensus")))((("decentralized systems", "consensus in")))Önceki bölümde, Bitcoin ağındaki herkesin yetkili mülkiyet kaydı olarak kabul ettiği tüm işlemlerin küresel kamu defteri olan blok zincirine baktık.

Ancak, ağdaki herkes, kimseye güvenmek zorunda kalmadan, kimin neye sahip olduğu konusunda tek bir evrensel "gerçek" üzerinde nasıl hemfikir olabilir? Tüm geleneksel ödeme sistemleri, temel olarak tüm işlemleri doğrulayan ve takas eden bir takas odası hizmeti sağlayan merkezi bir otoritenin güven modeline bağlıdır. Bitcoin'in merkezi bir yetkisi yoktur, ancak bir şekilde her full node, yetkili kayıt olarak güvenebileceği bir kamu defterinin tam bir kopyasına sahiptir. Blok zinciri, merkezi bir otorite tarafından oluşturulmaz, ağdaki her node tarafından bağımsız olarak oluşur. Bir şekilde, ağdaki her node, güvenli olmayan ağ bağlantıları üzerinden iletilen bilgiler üzerinde hareket ederek, herkesle aynı sonuca varabilir ve aynı genel muhasebe defterinin bir kopyasını bir araya getirebilir. Bu bölüm, Bitcoin ağının merkezi otorite olmadan küresel fikir birliğine ulaşma sürecini incelemektedir. 

((("emergent consensus")))((("mining and consensus", "emergent consensus")))Satoshi Nakamoto'nun ana icadı, ortaya çıkan konsensüs (fikir birliği) için merkeziyetsiz mekanizmadır. Ortaya çıkar, çünkü fikir birliği açıkça sağlanmaz - fikir birliğinin gerçekleştiği hiçbir seçim veya sabit bir an yoktur. Bunun yerine konsensüs, tümü basit kuralları izleyen binlerce bağımsız node’un asenkron etkileşiminin ortaya çıkan bir eseridir. Para birimi, işlemler, ödemeler ve merkezi otoriteye veya güvene bağlı olmayan güvenlik modeli dahil olmak üzere bitcoin'in tüm özellikleri bu buluştan kaynaklanmaktadır.

Bitcoin'in merkeziyetsiz konsensüsü, ağdaki node’larda bağımsız olarak gerçekleşen dört sürecin etkileşiminden ortaya çıkar:

[role="pagebreak-before"]
* Kapsamlı bir kriter listesine dayalı olarak her işlemin her full node tarafından bağımsız olarak doğrulanması
* Madencilik node’ları tarafından bu işlemlerin bağımsız olarak yeni bloklarda toplanması ve bir Proof of Work algoritması ile kanıtlanan hesaplama ile birleştirilmesi
* Her node tarafından yeni blokların bağımsız olarak doğrulanması ve zincire eklenmesi.
* Her bir node içerisinden bağımsız seçilen, zincirin kümülatif hesaplanması Proof-of-Work ile gösterdi.

Sonraki birkaç bölümde, bu süreçleri ve herhangi bir Bitcoin node’unun yetkili, güvenilir, halka açık, küresel defterin kendi kopyasını oluşturmasına izin veren ağ çapında fikir birliğinin ortaya çıkan özelliğini oluşturmak için nasıl etkileşime girdiklerini inceleyeceğiz.

[[tx_verification]]
=== Bağımsız İşlem Doğrulaması

((("mining and consensus", "independent transaction verification")))((("transactions", "independent verification of")))In <<İşlemler>>, bölümünde, cüzdan yazılımının UTXO toplayarak, uygun kilit açma komut dosyalarını sağlayarak ve ardından yeni bir sahibe atanan yeni çıktılar oluşturarak işlemleri nasıl oluşturduğunu gördük. Ortaya çıkan işlem daha sonra Bitcoin ağındaki komşu node’lara gönderilir, böylece tüm Bitcoin ağı boyunca yayılabilir.

Ancak işlemleri komşularına iletmeden önce, işlem alan her Bitcoin node’u önce işlemi doğrular. Bu, ağ üzerinde yalnızca geçerli işlemlerin yayılmasını sağlarken, geçersiz işlemler bunlarla karşılaşan ilk node’da atılır.

Her node, her işlemi uzun bir ölçüt listesiyle karşılaştırır ve buna göre doğrular:

*	İşlemin syntex’i (sözdizimi) ve veri yapısı doğru olmalıdır.
*	Ne girdiler ne de çıktılar boş değildir.
*	İşlem boyutu, tx_check.cpp'de gösterildiği gibi, tanık verilerini hariç tutan bir blok için izin verilen maksimum boyuttan daha küçüktür.
*	Her çıktı değeri ve toplam, izin verilen değerler aralığında olmalıdır (21 milyon tokenden az, toz eşiğinden fazla).
*	Girdilerin hiçbirinde hash=0, N=–1 yoktur (coinbase işlemleri aktarılmamalıdır).
*	nLocktime, INT_MAX'a eşittir veya nLocktime ve nSequence değerleri MedianTimePast'e göre karşılanır.
*	Bayt cinsinden işlem boyutu 82'ye eşit veya daha büyük.
*	İşlemde yer alan imza işlemleri (SIGOPS) sayısı, imza işlem sınırından daha azdır.
*	Kilit açma komut dosyası (scriptSig) yalnızca yığındaki sayıları itebilir ve kilitleme komut dosyası (scriptPubkey) IsStandard formlarıyla eşleşmelidir (bu, "standart olmayan" işlemleri reddeder).
*	Havuzda (pool) veya main branch’taki bir blokta eşleşen bir işlem mevcut olmalıdır.
*	Her girdi için, başvurulan çıktı havuzdaki (pool) başka herhangi bir işlemde mevcutsa, işlem reddedilmelidir.
*	Her giriş için, ana işlemi bulmak için main branch’e ve işlem havuzuna bakın. Herhangi bir girdi için ana işlem eksikse, bu yetim (orphan) bir işlem olacaktır. Havuzda eşleşen bir işlem yoksa, artık işlemler havuzuna (orphan transactions pool) ekleyin.
*	Her giriş için, eğer ana işlemi bir coinbase işlemi ise, en az COINBASE_MATURITY (100) onayına sahip olmalıdır.
*	Her girdi için başvurulan çıktı mevcut olmalıdır ve zaten harcanamaz.
*	Giriş değerlerini almak için ana işlemleri kullanarak, toplamın yanı sıra her bir giriş değerinin izin verilen değer aralığında olduğunu kontrol edin (21 milyon tokenden az, 0'dan fazla).
*	Girdi değerlerinin toplamı çıktı değerlerinin toplamından küçükse reddedin.
*	İşlem ücretinin (minRelayTxFee) boş bir bloğa giremeyecek kadar düşük olması durumunda reddedin.
*	Her giriş için kilit açma komut dosyaları, karşılık gelen çıkış kilitleme komut dosyalarına göre doğrulamalıdır.

Bu koşullar Bitcoin Core'daki AcceptToMemoryPool, CheckTransaction ve CheckInputs işlevlerinde ayrıntılı olarak görülebilir. denial-of-service (hizmet reddi saldırıları)saldırı türlerini ele almak veya bazen kuralları daha fazla işlem türünü içerecek şekilde gevşetmek için koşulların zaman içinde değiştiğini unutmayın.

Her bir işlemi, alındığı gibi ve yayılmadan önce bağımsız olarak doğrulayarak, her node, işlem havuzu, bellek havuzu veya mempool olarak bilinen geçerli (ancak onaylanmamış) işlemlerden oluşan bir havuz oluşturur.

=== Madencilik Node’ları

((("mining and consensus", "mining nodes")))((("Bitcoin nodes", "mining nodes")))Bitcoin ağındaki bazı node’lar, madenciler adı verilen özel node’lardır. <<ch01_intro_what_is_bitcoin>>'de Çin'in Şangay kentinde bir bilgisayar mühendisliği öğrencisi olan ve bitcoin madenciliği yapan Jing'i tanıttık. Jing, bitcoin madenciliği yapmak için tasarlanmış özel bir bilgisayar donanımı sistemi olan bir "madencilik teçhizatı" çalıştırarak bitcoin kazanır. Jing'in özel madencilik donanımı, tam bir Bitcoin node’u çalıştıran bir sunucuya bağlı. Jing'in aksine, Madencilik Havuzlarında göreceğimiz gibi, bazı madenciler full node olmadan madencilik yaparlar. Diğer tüm tam node’lar gibi, Jing'in node’u de Bitcoin ağındaki onaylanmamış işlemleri alır ve yayar. Ancak Jing'in node’u, bu işlemleri yeni bloklar halinde toplar.

Jing'in node’u, tüm node’lar gibi Bitcoin ağında yayılan yeni blokları dinliyor. Bununla birlikte, yeni bir bloğun gelişinin bir madencilik node’u için özel bir önemi vardır. Madenciler arasındaki rekabet, kazananın duyurusu olarak hareket eden yeni bir bloğun yayılmasıyla etkin bir şekilde sona erer. Madenciler için geçerli bir yeni blok almak, bir başkasının rekabeti kazandığı ve kaybettiği anlamına gelir. Ancak, bir müsabakanın bir turunun sonu aynı zamanda bir sonraki turun başlangıcıdır. Yeni blok sadece damalı bir bayrak değil, yarışın sonunu işaret ediyor; aynı zamanda bir sonraki blok için yarışta başlangıç tabancasıdır.

=== İşlemleri Bloklara Toplama

((("mining and consensus", "aggregating transactions into blocks", id="MACaggreg10")))((("transactions", "aggregating into blocks", id="Taggreg10")))((("blocks", "aggregating transactions into", id="Baggreg10")))((("blocks", "candidate blocks")))((("candidate blocks")))((("transaction pools")))((("memory pools (mempools)")))İşlemleri doğruladıktan sonra, bir Bitcoin node’u bunları bellek havuzuna veya işlemlerin bir bloğa dahil edilene (çıkarılana) kadar beklediği işlem havuzuna ekleyecektir. Jing'in node’u, diğer tüm node’lar gibi yeni işlemleri toplar, doğrular ve iletir. Ancak diğer node’ların aksine, Jing'in node’u bu işlemleri bir aday blokta toplayacaktır.

Alice'in Bob's Cafe'den bir fincan kahve aldığı sırada oluşan blokları takip edelim (bkz <<cup_of_coffee>>). Alice'in işlemi 277,316 bloğa dahil edildi. Bu bölümdeki kavramları göstermek amacıyla, bloğun Jing'in madencilik sistemi tarafından çıkarıldığını varsayalım ve bu yeni bloğun bir parçası olurken Alice'in işlemini takip edelim.

Jing'in madencilik node’u, blok zincirinin yerel bir kopyasını tutar. Alice kahveyi satın aldığında, Jing'in node’u 277.314 bloğa kadar bir zincir oluşturdu. Jing'in node’u işlemleri dinliyor, yeni bir blok madenciliği yapmaya çalışıyor ve ayrıca diğer node’lar tarafından keşfedilen blokları dinliyor. Jing'in node’u madencilik yaparken, Bitcoin ağı üzerinden 277.315 bloğunu alıyor. Bu bloğun gelişi, 277.315 blok için yarışmanın sona erdiğini ve 277.315 bloğu oluşturmak için yarışmanın başladığını gösterir. 

Önceki 10 dakika boyunca Jing'in node’u 277.315 blok için bir çözüm ararken, bir sonraki bloğa hazırlık olarak işlemleri de topluyordu. Şimdiye kadar bellek havuzunda birkaç yüz işlem topladı. 277.315 bloğunu alıp doğruladıktan sonra, Jing'in node’u onu bellek havuzundaki tüm işlemlerle karşılaştıracak ve 277.315 bloğuna dahil edilenleri kaldıracaktır. Bellek havuzunda kalan işlemler onaylanmaz ve yeni bir bloğa kaydedilmeyi bekler.

((("Proof-of-Work algorithm")))((("mining and consensus", "Proof-of-Work algorithm"))Jing'in node’u hemen yeni bir boş blok oluşturur, blok 277,316 için bir adaydır. Geçerli bir Proof-of-Work içermediğinden henüz geçerli bir blok olmadığı için bu bloğa aday blok denir. Blok, yalnızca madenci Proof-of-Work algoritmasına bir çözüm bulmayı başarırsa geçerli olur.

Jing'in node’u bellek havuzundaki tüm işlemleri topladığı zaman, yeni aday blokta toplam işlem ücreti 0,09094928 bitcoin olan 418 işlem bulunur. Blok 277,316'yı almak için komut satırını kullanma bölümünde gösterildiği gibi, Bitcoin Core istemci komut satırı arayüzünü kullanarak bu bloğu blok zincirinde görebilirsiniz.

[[block277316]]
.277,316 bloğunu almak için komut satırını kullanma
====
[source,bash]
----
